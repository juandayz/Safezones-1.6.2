...
SPEEDLIMIT = 35;        // Only used if USE_SPEEDLIMIT is true.
...
[_infiSZ] spawn {
    ...
    _startSafeZone =
    {
        ...
        {
_titleText = format[
("<img image='scripts\safezone\server.paa' /><br/>
<t font='TahomaB' size='0.7' color='#ffffff' align='right' shadow='1' shadowColor='#000000'>ENTERING IN </t><br />
<t shadow='1'shadowColor='#41924B' font='TahomaB' size='0.5' color='#00FF00' align='right'>A NEUTRAL ZONE</t>")];
[_titleText,[safezoneX + safezoneW - 0.5,0.35],[safezoneY + safezoneH - 0.8,0.7],3,0.5] spawn BIS_fnc_dynamicText;

            //taskHint [_txt, [0,1,0,1], 'taskDone'];
            inNow = nil;
            outNow = true;
    ...
    _endSafeZone =
    {
        if (isNil 'inNow') then
        {
            if (str fnc_usec_damageHandler == '{}') then
            {
                _titleText = format[
("<img image='scripts\safezone\server.paa' /><br/>
<t font='TahomaB' size='0.7' color='#ffffff' align='right' shadow='1' shadowColor='#000000'>LEAVING </t><br />
<t shadow='1'shadowColor='#41924B' font='TahomaB' size='0.5' color='#00FF00' align='right'>THE NEUTRAL ZONE</t>")];
[_titleText,[safezoneX + safezoneW - 0.5,0.35],[safezoneY + safezoneH - 0.8,0.7],3,0.5] spawn BIS_fnc_dynamicText;


               // taskHint [_txt, [1,0,0.1,1], 'taskFailed'];
            };
            inNow = true;
            outNow = nil;
